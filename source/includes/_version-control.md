...
01/12/2025 | Rafel Mestre | 1.1.37 | Se añaden los nuevos filtros (checkInDateFrom y checkInDateTo) en la petición de recuperación de reservas, para obtener las reservas por fecha de checkIn.